...
// ../../node_modules/react-data-to-export/dist/ExcelPlugin/elements/ExcelColumn.js
var require_ExcelColumn = __commonJS({
  "../../node_modules/react-data-to-export/dist/ExcelPlugin/elements/ExcelColumn.js"(exports) {
    "use strict";
    ...
    var ExcelColumn = function(_React$Component) {
      _inherits(ExcelColumn2, _React$Component);
      function ExcelColumn2() {
        _classCallCheck(this, ExcelColumn2);
        return _possibleConstructorReturn(this, (ExcelColumn2.__proto__ || Object.getPrototypeOf(ExcelColumn2)).apply(this, arguments));
      }
      _createClass(ExcelColumn2, [{
        key: "render",
...
// ../../node_modules/react-data-to-export/dist/ExcelPlugin/elements/ExcelSheet.js
var require_ExcelSheet = __commonJS({
  "../../node_modules/react-data-to-export/dist/ExcelPlugin/elements/ExcelSheet.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _ExcelColumn = require_ExcelColumn();
    ...
    var ExcelSheet = function(_React$Component) {
      _inherits(ExcelSheet2, _React$Component);
      function ExcelSheet2() {
        _classCallCheck(this, ExcelSheet2);
        return _possibleConstructorReturn(this, (ExcelSheet2.__proto__ || Object.getPrototypeOf(ExcelSheet2)).apply(this, arguments));
      }
      _createClass(ExcelSheet2, [{
        key: "render",
        value: function render() {
          return null;
        }
...
// ../../node_modules/react-data-to-export/dist/ExcelPlugin/utils/DataUtil.js
var require_DataUtil = __commonJS({
  "../../node_modules/react-data-to-export/dist/ExcelPlugin/utils/DataUtil.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _xlsx = (init_xlsx(), __toCommonJS(xlsx_exports));
    var _xlsx2 = _interopRequireDefault(_xlsx);
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var strToArrBuffer = function strToArrBuffer2(s) {
    ...
    var dateToNumber = function dateToNumber2(v, date1904) {
      if (date1904) {
        v += 1462;
      }
    ...
    var excelSheetFromDataSet = function excelSheetFromDataSet2(dataSet) {
      if (dataSet === void 0 || dataSet.length === 0) {
        return {};
      }
      var ws = {};
      var range = { s: { c: 1e7, r: 1e7 }, e: { c: 0, r: 0 } };
      ...
      dataSet.forEach(function(dataSetItem) {
        ...
        if (columns.length >= 0) {
          columns.forEach(function(col, index) {
            var cellRef2 = _xlsx2.default.utils.encode_cell({
              c: xSteps + index,
              r: rowCount
            });
            fixRange(range, 0, 0, rowCount, xSteps, ySteps);
            getCell(col, cellRef2, ws);
          });
          rowCount += 1;
        }
        ...
        for (var i = 0; i < dataSet.length; i++) {
          ...
          if (columns) {
            for (var j = 0; j < columns.length; j++) {
              ...
              columnWidths.push({
                wpx: 64
                // 64px is default column width in excel
              });
            }
          }
        }
    ...
    var excelSheetFromAoA = function excelSheetFromAoA2(data) {
      var ws = {};
      var range = { s: { c: 1e7, r: 1e7 }, e: { c: 0, r: 0 } };
      for (var R = 0; R != data.length; ++R) {
        for (var C = 0; C != data[R].length; ++C) {
...
// ../../node_modules/react-data-to-export/dist/ExcelPlugin/components/ExcelFile.js
var require_ExcelFile = __commonJS({
  "../../node_modules/react-data-to-export/dist/ExcelPlugin/components/ExcelFile.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _fileSaver = require_FileSaver();
    var _xlsx = (init_xlsx(), __toCommonJS(xlsx_exports));
    var _xlsx2 = _interopRequireDefault(_xlsx);
    var _ExcelSheet = require_ExcelSheet();
    var _ExcelSheet2 = _interopRequireDefault(_ExcelSheet);
    var _DataUtil = require_DataUtil();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    function _classCallCheck(instance, Constructor) {
    ...
    var ExcelFile = function(_React$Component) {
      _inherits(ExcelFile2, _React$Component);
      function ExcelFile2(props) {
        _classCallCheck(this, ExcelFile2);
        var _this = _possibleConstructorReturn(this, (ExcelFile2.__proto__ || Object.getPrototypeOf(ExcelFile2)).call(this, props));
      ...
      _createClass(ExcelFile2, [{
        key: "createSheetData",
        value: function createSheetData(sheet) {
          var columns = sheet.props.children.filter(function(child) {
            return !!child;
          });
          ...
          data.forEach(function(row) {
            ...
            _react2.default.Children.forEach(columns, function(column) {
              var getValue = typeof column.props.value === "function" ? column.props.value : function(row2) {
                return row2[column.props.value];
              };
        ...
        key: "render",
        value: function render() {
          var _props = this.props, hideElement = _props.hideElement, element = _props.element;
          if (hideElement) {
            return null;
          } else {
...
// ../../node_modules/react-data-to-export/dist/index.js
var require_dist = __commonJS({
  "../../node_modules/react-data-to-export/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _ExcelFile = require_ExcelFile();
...
*/
//# sourceMappingURL=react-data-to-export.js.map
