import type { BaseTraceFrame } from '../../node/utils/index.js';
import { TraceType } from '../../node/utils/index.js';
...
export declare const isCompletionStartTrace: (trace: BaseTraceFrame) => trace is CompletionStartTrace;
export declare const isCompletionStartTraceSpeak: (trace: CompletionStartTrace) => trace is CompletionStartTraceSpeak;
export declare const isCompletionStartTraceText: (trace: CompletionStartTrace) => trace is CompletionStartTraceText;
//# sourceMappingURL=completion-start-trace.d.ts.map